...
/// 앱 내 삭제대기함 상태
/// PhotoKit에서 실제 삭제하지 않고 로컬에만 저장하는 삭제대기함 상태
///
...
public struct TrashState: Codable, Sendable {
    ...
    /// 삭제 시각 맵
    /// Key: assetID, Value: 삭제대기함으로 이동한 시각
    ...
    /// TrashState 초기화
    /// - Parameters:
    ///   - trashedAssetIDs: 삭제대기함에 있는 사진 ID 집합 (기본: 빈 Set)
