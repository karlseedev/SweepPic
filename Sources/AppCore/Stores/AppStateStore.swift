...
public final class AppStateStore: AppStateStoreProtocol {
    ...
    public func handleMemoryWarning() {
        print("[AppStateStore] Memory warning received, clearing caches")
        ...
        print("[AppStateStore] Memory warning handled")
    }

    /// 백그라운드 전환 처리
    public func handleBackgroundTransition() {
        print("[AppStateStore] App entering background")
        ...
        print("[AppStateStore] Background transition handled")
    }

    /// 포그라운드 전환 처리
    public func handleForegroundTransition() {
        print("[AppStateStore] App entering foreground")
        ...
        print("[AppStateStore] Foreground transition handled")
    }
}
