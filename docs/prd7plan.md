...
```
파일: SweepPic/SweepPic/Shared/Utils/HapticFeedback.swift
...
### T0-2: ToastView 컴포넌트
```
파일: SweepPic/SweepPic/Shared/Components/ToastView.swift
...
```
파일: SweepPic/SweepPic/Features/Shared/TrashStore.swift
