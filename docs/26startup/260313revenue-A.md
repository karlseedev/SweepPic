...
| 항목 | 값 | 근거 |
|------|---|------|
| iOS 전환율 (1년차) | **7%** | 체험 시작률 25% × Trial→Paid 28% — 론칭 초기 얼리어답터 + 프로모션 효과 (아래 상세) |
| iOS 전환율 (2년차~) | **5%** | 체험 시작률 20% × Trial→Paid 26% — 시장 확대에 따른 보수적 적용 (아래 상세) |
| Android 전환율 | **iOS × 30%** | iOS 대비 ARPU 49%, 전환율도 비례 하향 (Adapty 2026) |
| 구독 가격 (월) | ₩4,400 ($2.99) | |
...
| SweepPic 체험 시작률 (Soft + 삭제한도 제한) | ~20~25% | Hard(10~15%)와 Soft(25~35%) 중간. 무료로 사용 가능하나 한도 제한으로 체험 유도 |
| **1년차 전환율 = 25% × 28%** | **~7.0% → 7%** | 론칭 초기 얼리어답터 + 프로모션 효과로 체험시작률·전환율 모두 상단 |
| **2년차~ 전환율 = 20% × 26%** | **~5.2% → 5%** | 시장 확대에 따라 일반 사용자 유입 증가, 보수적 적용 |
...
|---:|:---:|:---:|------:|------:|------:|-------:|-------:|------:|-------:|
| 1 | 1차 | 소프트론칭 | 0만 | 294 | 21 | 7.0만 | 0.2만 | 7.3만 | 7.3만 |
| 3 | 1차 | 한국론칭 | 510만 | 6,154 | 475 | 162.0만 | 5.7만 | 167.8만 | 191.5만 |
| 4 | 1차 | 글로벌론칭 | 1,000만 | 7,108 | 952 | 324.4만 | 11.7만 | 336.1만 | 527.6만 |
| 5 | 1차 | 유지 | 900만 | 7,334 | 1,423 | 485.1만 | 17.9만 | 502.9만 | 1,030.6만 |
| 6 | 1차 | 사비전환 | 699만 | 5,704 | 1,760 | 599.7만 | 22.7만 | 622.4만 | 1,653.0만 |
| 7 | 1차 | 사비 | 520만 | 4,519 | 1,998 | 681.0만 | 26.6만 | 707.5만 | 2,360.5만 |
| 8 | 1차 | 사비 | 471만 | 4,019 | 2,191 | 746.7만 | 30.0만 | 776.7만 | 3,137.2만 |
| 9 | 1차 | 사비 | 512만 | 5,688 | 2,428 | 827.5만 | 34.9만 | 862.4만 | 3,999.6만 |
| 10 | 1차 | 사비 | 563만 | 6,482 | 2,692 | 917.5만 | 40.5만 | 958.0만 | 4,957.6만 |
| 14 | 2차 | 재투자 | 719만 | 10,038 | 3,611 | 1,230.9만 | 72.4만 | 1,303.3만 | 9,624.3만 |
| 22 | 2차 | 재투자 | 1,290만 | 17,005 | 6,331 | 2,158.0만 | 168.5만 | 2,326.4만 | 24,317.9만 |
| 34 | 3차 | 재투자 | 3,148만 | 41,727 | 15,263 | 5,202.1만 | 479.0만 | 5,681.1만 | 71,433.7만 |
| 46 | 4차 | 재투자(60%) | 5,496만 | 72,833 | 30,338 | 10,340.1만 | 1,060.3만 | 11,400.4만 | 173,261.6만 |
| 58 | 5차 | 재투자(50%) | 7,913만 | 108,401 | 51,267 | 17,473.5만 | 1,979.2만 | 19,452.7만 | 358,474.4만 |
...
| 재투자율 | 70% | 70% | 70% | 60% | 50% |
| iOS 전환율 | 7% | 5% | 5% | 5% | 5% |
| 총 광고비 | 5,180만 | 10,705만 | 26,038만 | 49,015만 | 75,293만 |
| 신규 설치 | 47,688건 | 145,839건 | 354,008건 | 660,935건 | 1,041,946건 |
| 누적 설치 | 47,688건 | 193,527건 | 547,535건 | 1,208,470건 | 2,250,416건 |
| 활성 구독자 | 2,692명 | 6,331명 | 15,263명 | 30,338명 | 51,267명 |
| 구독 매출 | 4,767만 | 18,143만 | 43,326만 | 92,674만 | 166,978만 |
| 광고 매출 | 191만 | 1,217만 | 3,790만 | 9,154만 | 18,235만 |
| 총매출 (Gross) | 4,958만 (0.50억) | 19,360만 (1.94억) | 47,116만 (4.71억) | 101,828만 (10.18억) | 185,213만 (18.52억) |
| 월말 매출 | 958.0만/월 | 2,326.4만/월 | 5,681.1만/월 | 11,400.4만/월 | 19,452.7만/월 |
| 런레이트 | 11,496만/년 (1.15억) | 27,917만/년 (2.79억) | 68,174만/년 (6.82억) | 136,805만/년 (13.68억) | 233,433만/년 (23.34억) |
...
|--|:---:|:---:|:---:|:---:|
| 설치 성장 | +206% | +143% | +87% | +58% |
| 매출 성장 | +291% | +143% | +116% | +82% |
| 구독자 성장 | +135% | +141% | +99% | +69% |
...
- 1년차: 정부 CPI 1,400만 + 사비 1,400만 + 매출 재투자 2,380만 = 총 5,180만 (레버리지 1.85배)
- 2년차: 매출 재투자만으로 10,705만 (정부지원 종료 후에도 광고 규모 확대)
- 3년차: 매출 재투자 26,038만 (1년차 정부 CPI의 18.6배 규모)
- 4년차: 재투자율 60%로 하향 → 인력 충원·운영비 확보, 광고비 49,015만
- 5년차: 재투자율 50%로 하향 → 안정적 수익 구조 전환, 광고비 75,293만

### 4-3. Android 효과

- 9개월차(12월)부터 Android 출시
- 3년차 신규 설치 약 354,000건 중 Android 비중 증가
...
- 4년차 60%: 월말 매출 11,400만 중 약 4,560만이 운영·인건비로 활용 가능
- 5년차 50%: 월말 매출 19,453만 중 약 9,726만이 운영·인건비로 활용 가능
- 재투자율 감소에도 매출은 지속 성장 (4→5년차 +82%)
...
| 1년차 총매출 | 4,958만 | 5,362만 | ×1.1 |
| 5년차 누적매출 | 35.85억 | 31.60억 | ×1.1 |
| 5년차 런레이트 | 23.34억/년 | 19.21억/년 | ×1.2 |

1년차 iOS 전환율 7% 적용으로 초기 매출이 높아지며, 복리 재투자 효과로 5년차에는 Plan B를 역전. 사비 앞집중 투자(1,400만)와 높은 초기 전환율이 예산 차이를 흡수.
...
| 3 | Android 전환율 | iOS×30%로 산출 (1년차 2.1%, 2년차~ 1.5%). 실제 Android 사진 정리 앱 전환율 데이터 부재 |
