...
|------|------|--------|--------|---------|----------|
| 1 | **LLDB 직접 명령** | ★★★★★ | ★★★ | ⚠️ SIP | 모든 속성 직접 조회 가능 |
| 2 | **Reveal** | ★★★★☆ | ★★☆ | ⚠️ 주입 | 시각적 + 상세 속성 |
| 3 | **Chisel (Facebook)** | ★★★★☆ | ★★☆ | ⚠️ SIP | pviews 계층 + 시각화 |
| 4 | **FLEX** | ★★★☆☆ | ★☆☆ | ❌ | 인앱 실시간 탐색 |
| 5 | **Xcode View Debugger** | ★★★☆☆ | ★☆☆ | ❌ | 통합 환경, 3D 뷰 |
| 6 | **Accessibility Inspector** | ★★☆☆☆ | ★☆☆ | ✅ | SIP 불필요, 시스템앱 OK |
| 7 | **Digital Color Meter** | ★★☆☆☆ | ★☆☆ | ✅ | 픽셀 색상 정확 측정 |
| 8 | **스크린샷 분석** | ★★☆☆☆ | ★★☆ | ✅ | 크기/간격 측정 |
