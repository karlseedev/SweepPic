...
> 작성일: 2026-03-13 (v4 수정: 2026-03-13)
> 목적: 사업계획서 매출 추정 근거
...
| 매출 재투자 | 실수령액의 80% → 다음 달 광고비로 재투자 (1인 개발, 인건비 별도) |
...
| 2년차~ | **₩2,700** | ASA국내 30% + ASA글로벌 70% (최적화 반영) | ASA 키워드·크리에이티브 A/B 최적화로 CPI 개선 |
...
| Android | - | 21개월차~ (iOS의 30%→) | 점진 증가 (최대 60%) | Adapty 2026: Android ARPU $69 vs iOS $140 |
...
|---:|:---:|------:|------:|------:|-------:|-------:|------:|-------:|
| 1 | 1차 | 250만 | 1,622 | 81 | 27.6만 | 0.6만 | 28.2만 | 28.2만 |
| 3 | 1차 | 290만 | 1,968 | 258 | 88.0만 | 1.8만 | 89.8만 | 176.2만 |
| 6 | 1차 | 358만 | 2,534 | 562 | 191.5만 | 4.3만 | 195.8만 | 653.9만 |
| 9 | 1차 | 438만 | 3,160 | 914 | 311.6만 | 7.3만 | 319.0만 | 1,483.7만 |
| 12 | 2차 | 263만 | 3,091 | 1,214 | 413.7만 | 10.3만 | 424.0만 | 2,646.6만 |
| 15 | 2차 | 343만 | 3,764 | 1,567 | 534.2만 | 14.0만 | 548.3만 | 4,162.6만 |
| 18 | 2차 | 437만 | 4,535 | 1,982 | 675.6만 | 18.5만 | 694.1만 | 6,094.0만 |
| 21 | 2차 | 547만 | 7,039 | 2,514 | 856.9만 | 24.4만 | 881.3만 | 8,527.8만 |
| 24 | 3차 | 738만 | 10,828 | 3,430 | 1,169.0만 | 34.5만 | 1,203.5만 | 11,793.8만 |
| 27 | 3차 | 1,008만 | 15,325 | 4,686 | 1,597.2만 | 48.9만 | 1,646.1만 | 16,257.9만 |
| 30 | 3차 | 1,370만 | 19,787 | 6,319 | 2,153.9만 | 68.0만 | 2,221.8만 | 22,317.7만 |
| 33 | 3차 | 1,828만 | 25,381 | 8,381 | 2,856.4만 | 92.5만 | 2,948.9만 | 30,399.9만 |
...
| 구독 매출 | 1,451만 | 6,861만 | 21,213만 |
| 광고 매출 | 33만 | 183만 | 659만 |
| **총매출 (Gross)** | **1,484만** | **7,044만** | **21,872만** |
| 월말 매출 | 319만/월 | 881만/월 | 2,949만/월 |
...
- 1년차: 정부 광고비 2,250만 + 매출 재투자 792만 = 총 3,042만 (레버리지 1.35배)
- 2년차: 매출 재투자만으로 4,408만 (정부지원 종료 후에도 광고 규모 확대)
- 3년차: 매출 재투자 13,467만 (1년차 정부지원의 6배 규모)

### 4-3. 3년차 Android 효과

- 21개월차(2년차 12개월)부터 Android 출시
- 3년차 신규 설치 195,144건 중 Android 비중 증가
...
| 항목 | v3 | v4 | 변경 사유 |
|------|----|----|----------|
| CPI (2년차) | ₩2,900 | ₩2,700 | ASA 키워드·크리에이티브 A/B 최적화에 따른 CPI 개선 반영 |
| 재투자 비율 | 70% | 80% | 1인 개발로 인건비 별도 확보, 매출 대부분 성장에 재투자 가능 |
| 바이럴 K (2~3년차) | 0.20 / 0.25 | 0.25 / 0.30 | 보상형 공유 루프·정리 리포트 공유 기능 강화 전제. Amplitude 강화K 범위(0.20~0.40) 내 |
| Android 시작 | 25개월차 | 21개월차 | 2년차 후반 출시로 앞당김. 사업계획상 Android 개발 일정과 정합 |
| DAU/MAU | 10% | 12% | 유틸리티 앱 벤치마크 10~15% 범위 내. 주기적 사용 유도 기능 반영 |
