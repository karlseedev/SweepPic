# PickPhoto BM 명세 — 누락 항목 Gap 분석 리서치
...
> **PickPhoto는 "Use & Forget" 또는 "Vault" 유형에 해당할 수 있음** — 사진 정리(Use & Forget) + 사진 보관/축적(Vault) 성격을 모두 가짐
