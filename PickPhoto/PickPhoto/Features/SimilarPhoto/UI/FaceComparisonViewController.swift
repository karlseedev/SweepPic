...
final class FaceComparisonViewController: UIViewController {
    ...
    private func runDetectionComparison(with photos: [PHAsset]) async {
        print("")
        print("╔══════════════════════════════════════════════════════════════════╗")
    ...
    private func matchDetectedFaces(
...
// MARK: - Detection Comparison Result
